...
class DiffOrbIntegration:
    ...
    def process_diff(self, download_file: str, template_file: str, output_dir: str = None, noise_methods: list = None, alignment_method: str = 'rigid', remove_bright_lines: bool = True, fast_mode: bool = False, max_jaggedness_ratio: float = 2.0, detection_method: str = 'contour', detection_snr_min: float = 5.0, overlap_edge_exclusion_px: int = 40, wcs_use_sparse: bool = False, generate_gif: bool = False, science_bg_mode: str = 'off', diff_calc_mode: str = 'abs', apply_diff_postprocess: bool = False) -> Optional[Dict]:
        """
        执行diff操作
